...
public:
	...
	*/
	...
	/*!
	\brief
		Set the right anchor window name.

	\param windowName
		The string object that hold name of the right anchor window.
	...
	*/
	...
	/*!
	\brief
		Get the right anchor window name.
	...
	*/
	...
	/*!
	\brief
		Set the bottom anchor window name.

	\param windowName
		The string object that hold name of the bottom anchor window.
...
protected:
	...
	*************************************************************************/
	...
	String			d_rightAnchor;	//!< Name of right anchor.
	String			d_bottomAnchor;	//!< Name of bottom anchor.
